        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
              <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8081/Swp391/login&response_type=code&client_id=1072652228256-j5i6qbii5sfdkc4vsffnrh5pmouu6ik0.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
